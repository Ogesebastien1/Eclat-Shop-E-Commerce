    ...
    >
      ...
      <div style={{ flex: 1 }}>
        ...
        >
          ...
          <p className="text-tiny/90" style={{ marginLeft: '90px', fontSize: '20px', color: 'white'}}>{item.price} €</p>
            <Button className="text-tiny bg-white/20" variant="flat" color="default" radius="lg" size="sm">
               Add to Cart
            </Button>
          </CardFooter>
        </Card>
